...
render_table(["Country", "1Y", "2Y", "10Y", "Daily change (10Y)"], [
    ...
    ["Japan", _jp_cell("1Y"), _jp_cell("2Y"), _jp10, _jpchg],
])
st.markdown('<div class="src">US = Treasury.gov; Japan = MOF JGB curve; India 10Y '
            '= FRED. India 1Y/2Y need a headless browser (work locally, not on '
            'Streamlit Cloud — no free HTTP feed exists for India short-tenor '
            'G-Sec).</div>', unsafe_allow_html=True)
